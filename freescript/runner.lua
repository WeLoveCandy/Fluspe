...
local window =
    library:new(
    {textsize = 13.5, font = Enum.Font.RobotoMono, name = "Fluspe hub", color = Color3.fromRGB(8, 12, 255)}
)

-- Page
local General = window:page({name = "General"})
local Auto = window:page({name = "Automatic"})
local Island = window:page({name = "Island"})
local Events = window:page({name = "Events"})
local Misc = window:page({name = "Miscellaneous"})

-- Side
local Generalr = General:section({name = "General", side = "left", size = 450})
